...
<tr>
    <td width="19%">
        <input 
            type="text" 
            name="ovabrw_schedule_time[saturday][]" 
    ...
    <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_adult_price[saturday][]" 
    ...
    <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_children_price[saturday][]" 
            placeholder="<?php esc_html_e( '10', 'ova-brw' ) ?>" 
            autocomplete="off" />
    </td>
     <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_baby_price[saturday][]" 
            placeholder="<?php esc_html_e( '10', 'ova-brw' ) ?>" 
            autocomplete="off" />
    </td>
    <td width="14%">
        <select name="ovabrw_schedule_type[saturday][]" class="short_dura">
            <option value="person">
