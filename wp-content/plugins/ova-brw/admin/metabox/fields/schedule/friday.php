...
<tr>
    <td width="19%">
        <input 
            type="text" 
            name="ovabrw_schedule_time[friday][]" 
    ...
    <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_adult_price[friday][]" 
    ...
    <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_children_price[friday][]" 
            placeholder="<?php esc_html_e( '10', 'ova-brw' ) ?>" 
            autocomplete="off" />
    </td>
     <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_baby_price[friday][]" 
            placeholder="<?php esc_html_e( '10', 'ova-brw' ) ?>" 
            autocomplete="off" />
    </td>
    <td width="14%">
        <select name="ovabrw_schedule_type[friday][]" class="short_dura">
            <option value="person">
