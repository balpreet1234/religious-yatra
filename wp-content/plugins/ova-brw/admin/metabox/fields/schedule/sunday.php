...
<tr>
    <td width="19%">
        <input 
            type="text" 
            name="ovabrw_schedule_time[sunday][]" 
    ...
    <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_adult_price[sunday][]" 
    ...
    <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_children_price[sunday][]" 
            placeholder="<?php esc_html_e( '10', 'ova-brw' ) ?>" 
            autocomplete="off" />
    </td>
     <td width="22%">
        <input 
            type="text" 
            name="ovabrw_schedule_baby_price[sunday][]" 
            placeholder="<?php esc_html_e( '10', 'ova-brw' ) ?>" 
            autocomplete="off" />
    </td>
    <td width="14%">
        <select name="ovabrw_schedule_type[sunday][]" class="short_dura">
            <option value="person">
